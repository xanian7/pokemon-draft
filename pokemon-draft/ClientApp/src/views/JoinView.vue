...
<template>
  <div class="page-center">
    <div class="auth-card">
      ...
      <!-- Discord Sign-In -->
      <button type="button" class="btn btn-discord" @click="loginWithDiscord">
      ...
      <div v-if="authStore.isSignedIn" class="google-signed-in">
        <img
        ...
        />
        <span
          >Signed in as <strong>{{ authStore.authUser?.name }}</strong></span
        >
